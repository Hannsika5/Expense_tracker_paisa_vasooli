...
const SimplifyDebt = ({ user, thememode, toggle }) => {
    ...
    const getGroup = async () => {
        try {
            const res = await axios.get(`https://expense-tracker-paisa-vasooli.onrender.com/api/group/getgroup/${id}`);
    ...
    const handleSubmit = (e) => {
        ...
        const simplify = async () => {
            try {
                const res = await axios.post(`https://expense-tracker-paisa-vasooli.onrender.com/api/group/simplifyDebt/${id}`, { outputArray });
                setData(res.data);
            } catch (err) {
                console.log(err);
            }
    ...
    useEffect(() => {
        const getDebts = async () => {
            try {
                const res = await axios.get(`https://expense-tracker-paisa-vasooli.onrender.com/api/group/getDebts/${id}`);
                setData(res.data);
            } catch (err) {
                console.log(err);
            }
    ...
    const handleAddComment = async () => {
        try {
            const res = await axios.post(`https://expense-tracker-paisa-vasooli.onrender.com/api/group/addcomment`, {
                userId: user._id,
                text: commentText,
                groupId: id,
    ...
    const getComments = async () => {
        try {
            const response = await axios.get(`https://expense-tracker-paisa-vasooli.onrender.com/api/group/getcomments/${id}`);
    ...
    const getMembers = async () => {
        try {
            const res = await axios.get(`https://expense-tracker-paisa-vasooli.onrender.com/api/group/getmembers/${id}`);
