...
const Stocks = ({user,thememode,toggle}) => {
    ...
    const handleSubmit = async()=>{
        try{
          if(input!=""){
            const res=await axios.post(`https://expense-tracker-paisa-vasooli.onrender.com/api/user/addStock/${user._id}`,{input})
    ...
    const handledelete = async(stock)=>{
      try{
        const res = await axios.put(`https://expense-tracker-paisa-vasooli.onrender.com/api/user/deletestock/${user._id}`,stock)
    ...
    useEffect(()=>{
      const getStocks = async()=>{ try{ const res=await axios.get(`https://expense-tracker-paisa-vasooli.onrender.com/api/user/getStocks/${user._id}`)
