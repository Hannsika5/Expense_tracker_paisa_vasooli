...
const handleAddFriendsToGroup=async()=>{
  try{
    console.log(friends)
    const res = await axios.put(`https://expense-tracker-paisa-vasooli.onrender.com/api/group/addfriendsgroup/${groupData._id}`,{friends})
...
const handleDelete = async()=>{
  try{
      const res=await axios.delete(`https://expense-tracker-paisa-vasooli.onrender.com/api/group/deleteGroup/${groupData._id}`)
